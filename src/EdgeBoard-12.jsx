      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{ position: 'relative', marginBottom: '24px' }}>
          <input 
            ...
            style={{ width: '100%', padding: '14px 20px', fontSize: '15px', backgroundColor: '#141722', border: '1px solid #1e293b', borderRadius: '12px', color: '#ffffff', boxSizing: 'border-box', outline: 'none', transition: 'border-color 0.2s', fontFamily: 'inherit' }}
          />
        </div>
              ...
              {filteredData.length > 0 ? (
                ...
                <tr>
                  <td colSpan="5" style={{ padding: '40px', textAlign: 'center', color: '#64748b', fontSize: '14px', fontWeight: '500' }}>
                    No market assets found matching your active filter criteria.
                  </td>
                </tr>
              )}
            </tbody>
